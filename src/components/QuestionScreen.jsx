...
<div className={`min-h-screen flex items-center justify-center p-3 sm:p-6 ${isDark ? "bg-zinc-900" : "bg-[#F8F8FC]"}`}>
      ...
      {/* Main Layout */}
  {/* Main Layout */}
<div className={`w-full max-w-6xl min-h-[90vh] rounded-[2rem] overflow-hidden shadow-[0_20px_80px_rgba(83,74,183,0.12)] border flex flex-col lg:flex-row ${
          ...
          <div className="flex-1 flex flex-col px-5 sm:px-8 py-6 sm:py-8">
            ...
            <div className="flex items-center justify-between gap-3 flex-wrap mb-5">
              ...
              <div>
               ...
               <h2 className={`text-2xl sm:text-4xl font-bold leading-tight max-w-2xl ${
