...
const QuestionScreen = () => {
  const { currentQ, handleAnswer } = useQuiz()
...
useEffect(() => {
  ...
  {/* Timer — mobile pe bhi dikhega */}
  <div className={` md:hidden flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold ${
    timeLeft <= 5 
          ...
          <div className="flex-1 flex flex-col px-5 sm:px-8 py-6 sm:py-8">
            ...
            <div className="flex items-center justify-between gap-3 flex-wrap mb-5">
              ...
              <div>
                ...
                <h2 className="text-2xl sm:text-4xl font-bold text-zinc-900 leading-tight max-w-2xl">
            ...
            <div className="mb-8">
              ...
              <div className="h-2 bg-[#EEEDFE] rounded-full overflow-hidden">
                <div
                  className="h-full bg-linear-to-r from-[#534AB7] to-[#7A70FF] rounded-full transition-all duration-500"
                  style={{
            ...
            <div className="grid gap-4">
              ...
              {questions[currentQ].options.map((option, index) => (
                <button
                  ...
                  className="group relative overflow-hidden bg-white border border-zinc-200 hover:border-[#534AB7] rounded-2xl p-4 sm:p-5 transition-all duration-300 hover:shadow-lg hover:shadow-[#534AB7]/10 hover:-translate-y-1 text-left"
                >
                  ...
                  <div className="relative flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-sm sm:text-base text-zinc-700 leading-relaxed group-hover:text-zinc-900 transition-colors">
                        {option}
                      </p>
                    </div>
        ...
        <div className="hidden lg:flex flex-1 bg-gradient-to-br from-[#534AB7] via-[#6B63FF] to-[#938DFF] relative overflow-hidden items-center justify-center">
          ...
          <div className="relative z-10 bg-white/10 backdrop-blur-xl border border-white/20 rounded-[2rem] p-10 w-[78%] text-white shadow-2xl">
            ...
            <p className="text-white/80 text-sm leading-relaxed mb-8">
              You're doing great. Keep answering quickly and accurately
